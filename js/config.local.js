window.WHITE_RAVEN_CONFIG = Object.assign(
  {
    fallbackPhotoBySlot: {
      /* ── HERO ────────────────────────────────────────────────
         Ron Trader: exterior with outdoor seating + redwoods    */
      'hero-main': {
      ...
      /* ── ABOUT ───────────────────────────────────────────────
         about-hero  → Ama Woo: White Raven building exterior
         about-detail → Anna Elshayeb: fresh pastries           */
      'about-hero': {
        photoUri: 'https://lh3.googleusercontent.com/place-photos/AL8-SNGYj25osZamK37Wh8um5uP7D5W547_B3UtZrJAlnE6RWnpd1OpvPxOf-LGlEzQlzGdzrkSlAFxvVkEMJOBYARVQzzdTYsbh2-MIx6lAhL_1e_rNXZQJBTWRUdsGe_haf0Agvz8OKRi-moM5W0E=s4800-w1600',
        backgroundSize: 'cover',
        backgroundPosition: 'center center',
        authorAttributions: [{ displayName: 'Ama Woo', uri: 'https://maps.google.com/maps/contrib/106764698252147583872' }]
      },
      'about-detail': {
      ...
      /* ── DRINKS ──────────────────────────────────────────────
         espresso → Grace Lee: interior espresso bar
         chai     → Grace Lee: the chai cup (XZM cup)
      ...
      /* ── ATMOSPHERE ──────────────────────────────────────────
         redwoods  → Ron Trader: exterior in the redwoods
         patio     → Ama Woo: building exterior / outdoor area
         study     → Grace Lee: interior espresso bar (workspace)
      ...
      /* ── LARRY'S CHAI SPOTLIGHT ──────────────────────────────
         chai-spotlight → section background (Grace Lee: chai cup)
         chai-portrait  → framed portrait photo (Grace Lee: chai cup)
         These are separate slots so each element gets its own photo. */
      'chai-spotlight': {
        photoUri: 'https://lh3.googleusercontent.com/place-photos/AL8-SNFHUFRh_VQqJ43h42GZ12vG4XQpN0bHzb9yu11XZx8uJaURrGzZO-pJNhX3HVLFvwINrkERw9Yrj-S4uaY-q5XdY_4_aKpXzbi3qpwbhUe71km2R9j3krwd8Ko467lq4EHm_v_5peGekpLb-w=s4800-w1600',
        backgroundSize: 'cover',
        backgroundPosition: 'center 30%',
